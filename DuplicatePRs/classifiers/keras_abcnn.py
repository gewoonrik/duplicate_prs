...
#copied from https://github.com/phdowling/abcnn-keras/blob/master/keras_abcnn.py <3
...
def ABCNN(
    ...
    if abcnn_1:
        ...
        conv_left = Convolution2D(
            nb_filter=1, nb_row=filter_width, nb_col=embed_dimensions, activation="tanh", border_mode="same",
            dim_ordering="th"
        )(left_embed_padded)
        ...
        conv_right = Convolution2D(
            nb_filter=1, nb_row=filter_width, nb_col=embed_dimensions, activation="tanh",
            border_mode="same",
            dim_ordering="th"
        )(right_embed_padded)
    ...
    pool_left = AveragePooling1D(pool_length=filter_width, stride=1, border_mode="same")(conv_left)
    pool_right = AveragePooling1D(pool_length=filter_width, stride=1, border_mode="same")(conv_right)
