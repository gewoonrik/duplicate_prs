...
tr_1, tr_2, tr_y = line_to_diff_files(load_csv(config.training_dataset_file))
val_1, val_2, val_y = line_to_diff_files(load_csv(config.validation_dataset_file))
te_1, te_2, te_y = line_to_diff_files(load_csv(config.test_dataset_file))
