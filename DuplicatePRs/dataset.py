...
def get_doc2vec_diff_file(owner, repo, id):
    return  _current_path+"/diffs_doc2vec_preprocessed/"+owner+"@"+repo+"@"+str(id)+".diff"

def get_doc2vec_title_file(owner, repo, id):
...
def get_doc2vec_data_diffs(lines):
    return _get_data(lines, get_doc2vec_diff_file, read_pickled)

def get_doc2vec_data_titles(lines):
    return _get_data(lines, get_doc2vec_title_file, read_pickled)
